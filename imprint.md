...
```
Minima: MIT License (https://github.com/jekyll/minima)
CutiveMono-Regular.ttf: Copyright 2012 The Cutive Project Authors (vern@newtypography.co.uk) SIL Open Font License, Version 1.1.
