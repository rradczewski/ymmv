...
module Jekyll
  class Image < Liquid::Tag
    ...
    def render(context)
      ...
      generated_src = ImageGeneration::generate_image(instance, site.source, site.dest, settings['source'], settings['output'])
  ...
  class ImageSrc < Liquid::Tag
    ...
    def render(context)
      ...
      File.join(site.baseurl, generated_src)
    end
...
Liquid::Template.register_tag('imagesrc', Jekyll::ImageSrc)
